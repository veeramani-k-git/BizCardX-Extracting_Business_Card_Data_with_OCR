...
if selected_menu == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(r"C:\projects\BizCardX\sample_images", uploaded_card.name), "wb") as f:
        ...
        extracted_text = reader.readtext(os.path.join(r"C:\projects\BizCardX\sample_images", uploaded_card.name), detail=0)
        content=[]
        ...
        if st.button("Save Data"):
            ...
            try:
                with open(os.path.join(r"C:\projects\BizCardX\sample_images", uploaded_card.name), "rb") as f:
                    image = f.read()
